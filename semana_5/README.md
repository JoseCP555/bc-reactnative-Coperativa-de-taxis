# Proyecto de la cooperativa · Semana 5: Networking y TanStack Query

Se incorporan consultas y mutations TanStack Query para viajes, más un resumen calculado de ingresos.
